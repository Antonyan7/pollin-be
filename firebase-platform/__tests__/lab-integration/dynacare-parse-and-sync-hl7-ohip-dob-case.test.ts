...
import {patientForLabIntegrationDynacareFixture} from '../fixtures/lab-integration/patient.fixture'
import {
...
describe('Dynacare Integration: parse and sync hl7 file', () => {
  ...
  // OHIP code is required, FirstName and LastName is different in patient fixture
  test('should parse & sync raw data: OBR - Linked, Result - WaitingCompletion. Case: OHIP+DOB+TEST', async () => {
    const file = await fs.readFile(__dirname + '/dynacare/dynacare-cbc-ohip-dob.hl7')
